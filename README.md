...
- Caves: large cheese **pockets** only (no spaghetti/noodle/carver snakes), ~3× wider / ~2× taller than vanilla cheese scale. Mid-depth = lush/dripstone/sulfur; deep band depth `[0.8, 1.2]` = deep dark
